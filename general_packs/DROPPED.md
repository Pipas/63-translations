...
The card is a phrase, not a thing. Translating the words leaves nothing to guess.
...
The object or hairstyle exists, but there's no word for it that a table would recognise.
...
These translate literally without much trouble. They were dropped because the result
wouldn't land at a Portuguese table: either the reference isn't recognisable here, or the
translated title just reads badly enough that the card stops being worth playing.
